<?php
	...
	echo "<body background='image/8.jpg'>";
...
<textarea name="testarea" rows="15" cols="87" style="background:none;margin-left: 0px;margin-top: 125px;width:630px;">回复内容</textarea><br>
<input type="submit" value="回复" style="background:none;">
</form>
</body>
</html>
